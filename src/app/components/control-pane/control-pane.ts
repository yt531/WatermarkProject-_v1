...
export class ControlPaneComponent {
  ...
  getPanelClass(menu: string) {
    const base = 'absolute bottom-[80px] left-0 w-full bg-white shadow-[0_-5px_20px_rgba(0,0,0,0.1)] rounded-t-2xl transition-all duration-300 flex flex-col max-h-[70vh] overflow-y-auto z-10 md:static md:bg-transparent md:shadow-none md:rounded-none md:transition-none md:max-h-none md:overflow-y-visible md:z-auto md:border-b md:border-[var(--color-border)] md:translate-y-0 md:opacity-100 md:visible md:pointer-events-auto';
